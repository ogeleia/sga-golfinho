...
function ValidaFormulario(){
 ...
 if ( document.cadastraraluno.endereco.value == "") {
  erro = erro + "Preencha o Endereço \n"
 }
 if ( document.cadastraraluno.telefone.value == "") {
  erro = erro + "Preencha o Telefone \n"
 }
 if ( document.cadastraraluno.rg.value == "") {
  erro = erro + "Preencha o RG \n"
 }
 if ( document.cadastraraluno.cpf.value == "") {
...
<form name="cadastraraluno" action="cadastraraluno.do" method="post">
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <tr>
                        ...
                        <td colspan="3" valign="middle"><input name="nome" type="text" id="nome" size="50" maxlength="100" value="">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input name="endereco" type="text" id="endereco" size="50" maxlength="100" value=""></td>
                      </tr>
                      <tr>
                        <td class="style1">Telefone:</td>
                        <td colspan="3"><input name="telefone" type="text" id="telefone" size="25" maxlength="100" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>
                      <tr>
                        <td class="style1">RG:</td>
                        <td width="30%"><input name="rg" type="text" id="rg" size="20" maxlength="15" onKeyPress="javascript:return OnlyNumbers(event);"></td>
                        <td width="18%"><div align="right"><span class="style1">CPF:</span></div></td>
                        <td width="41%"><input name="cpf" type="text" id="cpf" size="25" maxlength="15" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>                    
                    </table></td>
                    <td>&nbsp;</td>
                  </tr>
