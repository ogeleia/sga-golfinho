<%-- 
    Document   : sgaTurma
    Created on : 10/12/2007, 14:41:16
    Author     : Hwoarang
--%>
             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td height="20" colspan="2" background="images/fundo_box.gif" bgcolor="#434037"><img src="images/turmas_08.gif" width="115" height="20"></td>
                    <td height="20">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">         
                            ...
                            <tr>
                                ...
                                <td width="88%" colspan="3" valign="middle">
                                    <form name="turma" action="turma.do" method="post">
                                      <input name="buscadescricao" type="text" size="40" maxlength="100" value="${busca}">
                                      <a href="Javascript:document.turma.submit()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)">
                                    <img src="images/btn_buscar.gif" name="Image30" width="72" height="24" border="0"></a>
                                        <a href="cadastroturma.do" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','images/bt_novo_h.gif',1)"><img src="images/btn_novo.gif" name="Image8" width="72" height="24" border="0"></a>
                                  </form>                                    </td>
                            </tr>
                            <tr>
                                <td class="style1">&nbsp;</td>
                            ...
                            <tr>
                                <td colspan="4" class="style1"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)"></a>
                                    ...
                                    <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#00A2E7">
                                        <tr>
                                            <td width="35%" bgcolor="#00A2E7"><div align="center"><span class="style3">Turma</span></div></td>
                                        </tr>                   
                                         <c:forEach var="turma" items="${turmaList}">
                                            <tr>
                                             <td class="style1"><a class="style1" href="editaturma.do?cod=<c:out value="${turma.codigo}"/>"><c:out value="${turma.descricao}"/></a></td>
                                            </tr>
                                        </c:forEach> 
                                            <c:if var="turma" test="${empty turmaList}">
                                                   <tr>
                                                    <td class="style1">Nenhuma turma encontrada</td>
                                                   </tr>
                                               </c:if>
                                    </table>             
