             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                 <tr>
					...
					<td height="20" colspan="2" ><img src="images/sga_08.gif" width="115" height="20" alt=""><img src="images/sga_h_09.gif" width="109" height="20"><a href="editamodalidadealuno.do?cod=${aluno.codigo}"><img src="images/sga_10.gif" width="125" height="20" alt="" border="0"></a><a href="historicoaluno.do?cod=${aluno.codigo}"><img src="images/sga_11.gif" width="105" height="20" alt="" border="0"></a><img src="images/sga_12.gif" height="20" alt=""></td>
					</c:forEach>
                                         <td height="20">&nbsp;</td>
				  </tr>
                  <tr>
