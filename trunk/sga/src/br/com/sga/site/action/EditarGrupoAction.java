 ...
 * @author Hwoarang
 */
public class EditarGrupoAction  extends Action {
    ...
    Session sessao = HibernateUtil.getSession(); // abrindo uma sessao
     ...
     try{
         //busca o objeto
         Grupo grupo = (Grupo) sessao.get(Grupo.class, new Integer(Integer.parseInt(request.getParameter("cod"))));     
         Grupo grupof = (Grupo) form;
         
         grupo.setNome(grupof.getNome());
         grupo.setStatus(grupof.getStatus());
