<%-- 
    Document   : sgaUsuario
    Created on : 10/12/2007, 14:34:22
    Author     : Hwoarang
--%>
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro">
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">         
                            <tr>
                                <td colspan="4"><a href="sgaCadastroUsuario.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','images/btn_cadastrar_h.gif',1)"><img src="images/btn_cadastrar.gif" name="Image31" width="111" height="24" border="0"></a><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('999','','images/btn_buscar_H.gif',1)"></a></td>
                            </tr>
                            <tr>
                                <td width="12%" class="style1">Busca:</td>
                                <td width="88%" colspan="3" valign="middle">
                                    <form name="usuario" action="usuario.do" method="post">
                                        <input name="buscanome" type="text" size="50" maxlength="100" value="${busca}">
                                        <a href="Javascript:document.usuario.submit()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)">
                            ...
                            <tr>
                                <td colspan="4" class="style1"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)"></a>
                                    ...
                                    <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#00A2E7">
                                        <tr>
                                            <td width="35%" bgcolor="#00A2E7"><div align="center"><span class="style3">Usuario</span></div></td>
                                        </tr>                   
                                         <c:forEach var="usuario" items="${usuarioList}">
                                            <tr>
                                             <td class="style1"><a class="style1" href="editausuario.do?cod=<c:out value="${usuario.codigo}"/>"><c:out value="${usuario.nome}"/></a></td>
                                            </tr>
                                            
                                        </c:forEach> 
                                            <c:if var="usuario" test="${empty usuarioList}">
                                                   <tr>
                                                    <td class="style1">Nenhum usuario encontrado</td>
                                                   </tr>
                                               </c:if>
