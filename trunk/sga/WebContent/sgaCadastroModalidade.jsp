<%-- 
    Document   : sgaCadastroModalidade
    Created on : 10/12/2007, 11:01:10
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 ...
 if ( document.cadastrarmodalidade.descricao.value == "") {
  erro = erro + "Preencha a Descrição \n"
 }
 if(erro == ""){
  document.cadastrarmodalidade.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="cadastrarmodalidade" action="cadastrarmodalidade.do" method="post">
             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                 <tr>
					...
					<td height="20" colspan="2" background="images/fundo_box.gif"><img src="images/modalidades_08.gif" width="115" height="20"><img src="images/sga_h_09.gif" width="109" height="20"></td>
				   <td height="20">&nbsp;</td>
				  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td width="5">&nbsp;</td>
                    <td width="638" height="37"><div align="right"><img src="images/sga_31.gif" width="72" height="24" alt="Salvar Modalidade" Onclick="ValidaFormulario();" border="0"> <a href="modalidade.do"><img src="images/sga_33.gif" width="72" height="24" alt="" border="0"></a></div></td>
