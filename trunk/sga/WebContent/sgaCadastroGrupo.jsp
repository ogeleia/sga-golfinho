<%-- 
    Document   : sgaEditaCadastroGrupo
    Created on : 09/12/2007, 23:40:40
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 ...
 if ( document.cadastrargrupo.nome.value == "") {
  erro = erro + "Preencha o Nome \n"
 }
  
 if(erro == ""){
  document.cadastrargrupo.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="cadastrargrupo" action="cadastrargrupo.do" method="post">
