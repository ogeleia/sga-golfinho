<%-- 
    Document   : sgaEditaCadastroModulo
    Created on : 10/12/2007, 11:23:59
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 var erro= "";
 if ( document.editarmodulo.nome.value == "") {
  erro = erro + "Preencha o Nome \n"
 }
 if(erro == ""){
  document.editarmodulo.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="editarmodulo" action="editarmodulo.do" method="post">
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <input type="hidden" name="cod" value="${modulo.codigo}">
                      <tr>
                        <td width="11%" class="style1">Nome:</td>
                        <td colspan="3" valign="middle"><input name="nome" type="text" id="nome" size="50" maxlength="45" value="${modulo.nome}">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><label>
                          <select name="status">
                            <option value="1" <c:if test="${modulo.status == '1'}"> selected </c:if> >Ativado</option>
                            <option value="0" <c:if test="${modulo.status == '0'}"> selected </c:if> >Desativado</option>
                          </select>
                        </label></td>
                      </tr>
                      </c:forEach>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td width="4">&nbsp;</td>
                    <td width="521" height="37"><div align="right"><img src="images/sga_31.gif" width="72" height="24" alt="Salvar Modulo" Onclick="ValidaFormulario();" border="0"> <a href="modulo.do"><img src="images/sga_33.gif" width="72" height="24" alt="" border="0"></a></div></td>
