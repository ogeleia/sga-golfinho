...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                 <tr>
				   <td width="11" height="20">&nbsp;</td>
					...
					<td height="20" colspan="2" ><img src="images/sga_08.gif" width="115" height="20" alt=""><a href="editaaluno.do?cod=${codigo}"><img src="images/sga_aba_cadastro_desativada.gif" width="109" height="20" border="0"></a><img src="images/sga_h_10.gif" width="125" height="20" alt="" border="0"><a href="editahistoricoaluno.do?cod=${codigo}"><img src="images/sga_11.gif" width="105" height="20" alt="" border="0"></a><img src="images/sga_12.gif" height="20" alt=""></td>
  ...
  <tr>
                                            <td width="35%" bgcolor="#00A2E7"><div align="center"><span class="style3">Modalidades</span></div></td>
                                        </tr>                   
                                         <c:forEach var="modalidade" items="${modalidadeList}">
                                            
                                                <tr>
                                                 <td class="style1"><c:out value="${modalidade.codigomatricula}"/></td>
                                                </tr>
