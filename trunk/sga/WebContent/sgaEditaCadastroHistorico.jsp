<%-- 
    Document   : sgaEditaCadastroHistorico
    Created on : 10/12/2007, 00:25:13
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 var erro= "";
 if ( document.editarhistorico.codigoaluno.value == "") {
  erro = erro + "Preencha o código do aluno \n"
 }
 if ( document.editarhistorico.data.value == "") {
  erro = erro + "Preencha a data \n"
 }
 if ( document.editarhistorico.tipo.value == "") {
  erro = erro + "Preencha o Tipo \n"
 }
 if ( document.editarhistorico.ocorrencia.value == "") {
  erro = erro + "Preencha a ocorrência \n"
 }

 if(erro == ""){
  document.editarhistorico.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="editarhistorico" action="editarhistorico.do" method="post">
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <input type="hidden" name="cod" value="${historico.codigo}">
                      <tr>
                        <td width="11%" class="style1">Nome:</td>
                        <td colspan="3" valign="middle"><input name="codigoaluno" type="text" id="codigoaluno" size="50" maxlength="45" value="${historico.codigoaluno}">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input name="data" type="text" id="data" size="25" maxlength="10" value="${historico.data}"></td>
                      </tr>
                      <tr>
                        <td class="style1">Tipo:</td>
                        <td colspan="3"><input name="tipo" type="text" id="tipo" size="25" maxlength="1" value="${historico.tipo}"></td>
                      </tr>
                      <tr>
                        <td class="style1">Ocorrência:</td>
                        <td colspan="3"><input name="ocorrencia" type="text" id="ocorrencia" size="25" maxlength="255" value="${historico.ocorrencia}"></td>
                      </tr>
                      </c:forEach>
                    </table></td>
                    <td>&nbsp;</td>
