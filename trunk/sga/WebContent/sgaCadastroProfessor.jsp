<%-- 
    Document   : sgaCadastroProfessor
    Created on : 10/12/2007, 14:15:48
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 ...
 if ( document.cadastrarprofessor.nome.value == "") {
  erro = erro + "Preencha o Nome \n"
 }
 if ( document.cadastrarprofessor.cref.value == "") {
  erro = erro + "Preencha o CREF \n"
 }
 if ( document.cadastrarprofessor.endereco.value == "") {
  erro = erro + "Preencha o Endereço \n"
 }
 if ( document.cadastrarprofessor.telefone.value == "") {
  erro = erro + "Preencha o Telefone \n"
 }
 if ( document.cadastrarprofessor.rg.value == "") {
  erro = erro + "Preencha o RG \n"
 }
 if ( document.cadastrarprofessor.cpf.value == "") {
  erro = erro + "Preencha o CPF \n"
 }
 
 if(erro == ""){
  document.cadastrarprofessor.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="cadastrarprofessor" action="cadastrarprofessor.do" method="post">
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <tr>
                        ...
                        <td colspan="3" valign="middle"><input name="nome" type="text" id="nome" size="50" maxlength="45" value="">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input name="cref" type="text" id="cref" size="50" maxlength="20" value=""></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input name="telefone" type="text" id="telefone" size="25" maxlength="25" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>
                      <tr>
                        <td class="style1">RG:</td>
                        <td width="30%"><input name="rg" type="text" id="rg" size="20" maxlength="20"></td>
                        <td width="18%"><div align="right"><span class="style1">CPF:</span></div></td>
                        <td width="41%"><input name="cpf" type="text" id="cpf" size="25" maxlength="14" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>                    
                    </table></td>
                    <td>&nbsp;</td>
                  </tr>
