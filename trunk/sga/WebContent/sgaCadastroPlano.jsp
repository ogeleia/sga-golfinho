<%-- 
    Document   : sgaCadastroPlano
    Created on : 10/12/2007, 11:46:29
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 ...
 if ( document.cadastrarplano.descricao.value == "") {
  erro = erro + "Preencha a Descrição \n"
 }
 if ( document.cadastrarplano.percentualdesconto.value == "") {
  erro = erro + "Preencha o Desconto \n"
 }

 if(erro == ""){
  document.cadastrarplano.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="cadastrarplano" action="cadastrarplano.do" method="post">
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input name="percentualdesconto" type="text" id="percentualdesconto" size="25" maxlength="14" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>
                    </table></td>
                    <td>&nbsp;</td>
                  </tr>
