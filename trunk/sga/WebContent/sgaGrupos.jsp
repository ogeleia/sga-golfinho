<%-- 
    Document   : sgaGrupos
    Created on : 09/12/2007, 23:39:38
    Author     : Hwoarang
--%>
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro">
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">         
                            <tr>
                                <td colspan="4"><a href="sgaCadastroGrupo.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','images/btn_cadastrar_h.gif',1)"><img src="images/btn_cadastrar.gif" name="Image31" width="111" height="24" border="0"></a><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('999','','images/btn_buscar_H.gif',1)"></a></td>
                            </tr>
                            <tr>
                                <td width="12%" class="style1">Busca:</td>
                                <td width="88%" colspan="3" valign="middle">
                                    <form name="grupo" action="grupo.do" method="post">
                                        <input name="buscanome" type="text" size="50" maxlength="100" value="${busca}">
                                        <a href="Javascript:document.grupo.submit()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)">
                            ...
                            <tr>
                                <td colspan="4" class="style1"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)"></a>
                                   <!-- comentado
                                    <display:table name="grupoList" class="tabela" cellpadding="1" cellspacing="1">
                                      <display:column property="codigo" title="Codigo" class="linhatabela1" href="editargrupo.do" paramId="cod" paramProperty="codigo" />                                          
                                      <display:column property="nome" title="Nome" class="linhatabela2" href="editargrupo.do" paramId="cod"  paramProperty="codigo" />   
                                    </display:table>
                                    -->
                                        <br>
                                    ...
                                    <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#00A2E7">
                                        <tr>
                                            <td width="35%" bgcolor="#00A2E7"><div align="center"><span class="style3">Grupo</span></div></td>
                                        </tr>                   
                                         <c:forEach var="grupo" items="${grupoList}">
                                            <tr>
                                             <td class="style1"><a class="style1" href="editagrupo.do?cod=<c:out value="${grupo.codigo}"/>"><c:out value="${grupo.nome}"/></a></td>
                                            </tr>
                                            
                                        </c:forEach> 
                                            <c:if var="grupo" test="${empty grupoList}">
                                                   <tr>
                                                    <td class="style1">Nenhum grupo encontrado</td>
                                                   </tr>
                                               </c:if>
