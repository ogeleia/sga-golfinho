<%-- 
    Document   : sgaFornecedor
    Created on : 09/12/2007, 21:53:00
    Author     : Hwoarang
--%>
             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td height="20" colspan="2" background="images/fundo_box.gif" bgcolor="#434037"><img src="images/fornecedores_08.gif" width="115" height="20"></td>
                    <td height="20">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <td width="88%" colspan="3" valign="middle">
                                    <form name="fornecedor" action="fornecedor.do" method="post">
                                      <input name="buscarazaosocial" type="text" size="40" maxlength="100" value="${busca}">
                                      <a href="Javascript:document.fornecedor.submit()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)">
                                    <img src="images/btn_buscar.gif" name="Image30" width="72" height="24" border="0"></a>
                                        <a href="sgaCadastroFornecedor.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','images/bt_novo_h.gif',1)"><img src="images/btn_novo.gif" name="Image8" width="72" height="24" border="0"></a>
                                    </form>                                    </td>
                            </tr>
                            <tr>
                                <td class="style1">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <!-- comentado
                                    <display:table name="fornecedorList" class="tabela" cellpadding="1" cellspacing="1">
                                      <display:column property="codigo" title="Codigo" class="linhatabela1" href="editarfornecedor.do" paramId="cod" paramProperty="codigo" />                                          
                                      <display:column property="razaosocial" title="razaosocial" class="linhatabela2" href="editarfornecedor.do" paramId="cod"  paramProperty="codigo" />   
                                      <display:column property="cpfcnpj" title="cpfcnpj" class="linhatabela3" href="editarfornecedor.do" paramId="cod" paramProperty="codigo" />
                                    </display:table>
                                  -->
                                        <br>
                                    ...
                                    <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#00A2E7">
                                        <tr>
                                            <td width="35%" bgcolor="#00A2E7"><div align="center"><span class="style3">Fornecedor</span></div></td>
                                        </tr>                   
                                         <c:forEach var="fornecedor" items="${fornecedorList}">
                                            <tr>
                                             <td class="style1"><a class="style1" href="editafornecedor.do?cod=<c:out value="${fornecedor.codigo}"/>"><c:out value="${fornecedor.razaosocial}"/></a></td>
                                            </tr>
                                        </c:forEach> 
                                            <c:if var="fornecedor" test="${empty fornecedorList}">
                                                   <tr>
                                                    <td class="style1">Nenhum fornecedor encontrado</td>
                                                   </tr>
                                               </c:if>
                                    </table>             
