<%-- 
    Document   : sgaEditaCadastroClasse
    Created on : 09/12/2007, 20:46:50
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 var erro= "";
 if ( document.editarclasse.classe.value == "") {
  erro = erro + "Preencha a descrição da classe \n"
 }
 if(erro == ""){
  document.editarclasse.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="editarclasse" action="editarclasse.do" method="post">
             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                 <tr>
					...
					<td height="20" colspan="2" ><img src="images/classes_08.gif" alt="" width="115" height="20"><img src="images/sga_h_09.gif" width="109" height="20"><img src="images/sga_12.gif" height="20" alt=""><img src="images/sga_12.gif" height="20" alt=""><img src="images/sga_12.gif" width="115" height="20"></td>
				   <td height="20">&nbsp;</td>
				  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <input type="hidden" name="cod" value="${classe.codigo}">
                      <tr>
                        <td width="11%" class="style1">Descrição:</td>
                        <td colspan="3" valign="middle"><input name="classe" type="text" id="classe" size="50" maxlength="45" value="${classe.classe}">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td width="4">&nbsp;</td>
                    <td width="561" height="37"><div align="right"><img src="images/sga_31.gif" width="72" height="24" alt="Salvar Classe" Onclick="ValidaFormulario();" border="0"> <a href="classe.do"><img src="images/sga_33.gif" width="72" height="24" alt="" border="0"></a></div></td>
                    <td width="351"><div align="right"></div></td>
                  </tr>
                </table>
             </td>
           </tr>           
