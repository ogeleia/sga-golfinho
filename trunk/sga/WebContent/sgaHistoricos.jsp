                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro">
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">         
                            <tr>
                                <td colspan="4"><a href="sgaCadastroAluno.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','images/btn_cadastrar_h.gif',1)"><img src="images/btn_cadastrar.gif" name="Image31" width="111" height="24" border="0"></a><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('999','','images/btn_buscar_H.gif',1)"></a></td>
                            </tr>
                            <tr>
...
<!-- Comentado
                                    <display:table name="alunoList" class="tabela" cellpadding="1" cellspacing="1">
                                      <display:column property="codigo" title="Codigo" class="linhatabela1" href="editaraluno.do" paramId="cod" paramProperty="codigo" />                                          
                                      <display:column property="nome" title="Nome" class="linhatabela2" href="editaraluno.do" paramId="cod"  paramProperty="codigo" />   
                                      <display:column property="cpf" title="cpf" class="linhatabela3" href="editaraluno.do" paramId="cod" paramProperty="codigo" />
                                    </display:table>
-->
                                        <br>
                                    ...
                                    <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#00A2E7">
                                        <tr>
                                            <td width="35%" bgcolor="#00A2E7"><div align="center"><span class="style3">Historico</span></div></td>
                                        </tr>                   
                                         <c:forEach var="historico" items="${historicoList}">
                                            <tr>
                                             <td class="style1"><a class="style1" href="abrehistorico.do?cod=<c:out value="${historico.codigo}"/>"><c:out value="${historico.ocorrencia}"/></a></td>
                                            </tr>
                                            
                                        </c:forEach> 
                                            <c:if var="aluno" test="${empty historicoList}">
                                                   <tr>
                                                    <td class="style1">Nenhum aluno encontrado</td>
                                                   </tr>
                                               </c:if>
