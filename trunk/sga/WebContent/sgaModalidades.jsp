...
<form name="modalidade" action="modalidade.do" method="post">
  <tr>    
             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td height="20" colspan="2" background="images/fundo_box.gif" bgcolor="#434037"><img src="images/modalidades_08.gif" width="115" height="20"></td>
                    <td height="20">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">         
                            ...
                            <tr>
                              ...
                              <td width="88%" colspan="3" valign="bottom">
                                      ...
                                      <a href="Javascript:document.modalidade.submit()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)">
                                      <img src="images/btn_buscar.gif" name="Image30" width="72" height="24" border="0"></a>&nbsp;<a href="sgaCadastroModalidade.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','images/bt_novo_h.gif',1)"><img src="images/btn_novo.gif" name="Image8" width="72" height="24" border="0"></a></td>
                            </tr>
                            <tr>
                                <td class="style1">&nbsp;</td>
                                <td colspan="3">&nbsp;</td>
                            ...
                            <tr>
                                <td colspan="4" class="style1"><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)"></a>
                                    ...
                                    <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#00A2E7">
                                        <tr>
                                            <td width="35%" bgcolor="#00A2E7"><div align="center"><span class="style3">Modalidade</span></div></td>
                                        </tr>                   
                                         <c:forEach var="modalidade" items="${modalidadeList}">
                                            <tr>
                                             <td class="style1"><a class="style1" href="editamodalidade.do?cod=<c:out value="${modalidade.codigo}"/>"><c:out value="${modalidade.descricao}"/></a></td>
                                            </tr>
                                        </c:forEach> 
                                            <c:if var="modalidade" test="${empty modalidadeList}">
                                                   <tr>
