<%-- 
    Document   : sgaEditaCadastroPlano
    Created on : 10/12/2007, 11:46:50
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 var erro= "";
 if ( document.editarplano.descricao.value == "") {
  erro = erro + "Preencha a Descrição \n"
 }
 if ( document.editarplano.percentualdesconto.value == "") {
  erro = erro + "Preencha o percentual de desconto \n"
 }

if(erro == ""){
  document.editarplano.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="editarplano" action="editarplano.do" method="post">
             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                 <tr>
					...
					<td height="20" colspan="2" background="images/fundo_box.gif" ><img src="images/planos_08.gif" width="115" height="20"><img src="images/sga_h_09.gif" width="109" height="20"></td>
				   <td height="20">&nbsp;</td>
				  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <input type="hidden" name="cod" value="${plano.codigo}">
                      <tr>
                        <td width="11%" class="style1">Descrição:</td>
                        <td colspan="3" valign="middle"><input name="descricao" type="text" id="descricao" size="50" maxlength="45" value="${plano.descricao}">
                          <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)"></a></td>
                      </tr>
                      <tr>
                        <td class="style1">% desconto:</td>
                        <td colspan="3"><input name="percentualdesconto" type="text" id="percentualdesconto" size="25" maxlength="25" value="${plano.percentualdesconto}"></td>
                      </tr>
                      </c:forEach>
                    </table></td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td width="4">&nbsp;</td>
                    <td width="521" height="37"><div align="right"><img src="images/sga_31.gif" width="72" height="24" alt="Salvar Plano" Onclick="ValidaFormulario();" border="0"> <a href="plano.do"><img src="images/sga_33.gif" width="72" height="24" alt="" border="0"></a></div></td>
