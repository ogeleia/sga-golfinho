<%-- 
    Document   : sgaProfessor
    Created on : 10/12/2007, 14:12:26
    Author     : Hwoarang
--%>
             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td height="20" colspan="2" background="images/fundo_box.gif" bgcolor="#434037"><img src="images/professores_08.gif" width="115" height="20"></td>
                    <td height="20">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">         
                            ...
                            <tr>
                                ...
                                <td width="88%" colspan="3" valign="middle">
                                    <form name="professor" action="professor.do" method="post">
                                        <input name="buscanome" type="text" size="40" maxlength="100" value="${busca}">
                                        <a href="Javascript:document.professor.submit()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image30','','images/btn_buscar_H.gif',1)">
                                        <img src="images/btn_buscar.gif" name="Image30" width="72" height="24" border="0"></a>
                                        <a href="sgaCadastroProfessor.jsp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','images/bt_novo_h.gif',1)"><img src="images/btn_novo.gif" name="Image8" width="72" height="24" border="0"></a>
                                      </form>
                                </td>
                            </tr>
                            <tr>
...
<!-- Comentado
                                    <display:table name="professorList" class="tabela" cellpadding="1" cellspacing="1">
                                      <display:column property="codigo" title="Codigo" class="linhatabela1" href="editarprofessor.do" paramId="cod" paramProperty="codigo" />                                          
                                      <display:column property="nome" title="Nome" class="linhatabela2" href="editarprofessor.do" paramId="cod"  paramProperty="codigo" />   
                                      <display:column property="cpf" title="cpf" class="linhatabela3" href="editarprofessor.do" paramId="cod" paramProperty="codigo" />
                                    </display:table>
-->
                                        <br>
                                    ...
                                    <table width="100%" border="1" cellpadding="1" cellspacing="1" bordercolor="#00A2E7">
                                        <tr>
                                            <td width="35%" bgcolor="#00A2E7"><div align="center"><span class="style3">Professor</span></div></td>
                                        </tr>                   
                                         <c:forEach var="professor" items="${professorList}">
                                            <tr>
                                             <td class="style1"><a class="style1" href="editaprofessor.do?cod=<c:out value="${professor.codigo}"/>"><c:out value="${professor.nome}"/></a></td>
                                            </tr>
                                            
                                        </c:forEach> 
                                            <c:if var="professor" test="${empty professorList}">
                                                   <tr>
                                                    <td class="style1">Nenhum professor encontrado</td>
                                                   </tr>
                                               </c:if>
