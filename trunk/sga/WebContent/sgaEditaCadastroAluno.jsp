             ...
             <td> 
                <table width="95%" height="360" border="0" cellpadding="0" cellspacing="0">
                 <tr>
					...
					<td height="20" colspan="2" ><img src="images/sga_08.gif" width="115" height="20" alt=""><img src="images/sga_h_09.gif" width="109" height="20"><a href="editamodalidadealuno.do?cod=${aluno.codigo}"><img src="images/sga_10.gif" width="125" height="20" alt="" border="0"></a><a href="editahistoricoaluno.do?cod=${aluno.codigo}"><img src="images/sga_11.gif" width="105" height="20" alt="" border="0"></a><img src="images/sga_12.gif" height="20" alt=""></td>
				   </c:forEach>
                                         <td height="20">&nbsp;</td>
				  </tr>
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <c:forEach var="aluno" items="${alunoList}">
                      <input type="hidden" name="cod" value="${aluno.codigo}">
                      <tr>
                        <td width="11%" class="style1">Nome:</td>
                        <td colspan="3" valign="middle"><input name="nome" type="text" id="nome" size="50" maxlength="100" value="${aluno.nome}">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input name="endereco" type="text" id="endereco" size="50" maxlength="100" value="${aluno.endereco}"></td>
                      </tr>
                      <tr>
                        <td class="style1">Telefone:</td>
                        <td colspan="3"><input name="telefone" type="text" id="telefone" size="25" maxlength="100" value="${aluno.telefone}" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>
                      <tr>
                        <td class="style1">RG:</td>
                        <td width="30%"><input name="rg" type="text" id="rg" size="20" maxlength="15" value="${aluno.rg}" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                        <td width="18%"><div align="right"><span class="style1">CPF:</span></div></td>
                        <td width="41%"><input name="cpf" type="text" id="cpf" size="25" maxlength="15" value="${aluno.cpf}" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>
                      <tr>
                        <td class="style1">Status:</td>
                        <td colspan="3"><label>
                          <select name="status">
                            <option value="1" <c:if test="${aluno.status == '1'}"> selected </c:if> >Ativado</option>
                            <option value="0" <c:if test="${aluno.status == '0'}"> selected </c:if> >Desativado</option>
                          </select>
                        </label></td>
                      </tr>
                      </c:forEach>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td width="4">&nbsp;</td>
                    <td width="521" height="37"><div align="right"><img src="images/sga_31.gif" width="72" height="24" alt="Salvar Aluno" Onclick="ValidaFormulario();" border="0"> <a href="aluno.do"><img src="images/sga_33.gif" width="72" height="24" alt="" border="0"></a></div></td>
