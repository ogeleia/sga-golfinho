<%-- 
    Document   : sgaCadastroModulo
    Created on : 10/12/2007, 11:22:27
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 ...
 if ( document.cadastrarmodulo.nome.value == "") {
  erro = erro + "Preencha o Nome \n"
 }
 
 if(erro == ""){
  document.cadastrarmodulo.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="cadastrarmodulo" action="cadastrarmodulo.do" method="post">
