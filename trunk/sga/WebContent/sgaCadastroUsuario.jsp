<%-- 
    Document   : sgaCadastroUsuario
    Created on : 10/12/2007, 14:36:22
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 ...
 if ( document.cadastrarusuario.nome.value == "") {
  erro = erro + "Preencha o Nome \n"
 }
 if ( document.cadastrarusuario.senha.value == "") {
  erro = erro + "Preencha a senha \n"
 }
 if ( document.cadastrarusuario.endereco.value == "") {
  erro = erro + "Preencha o Endereço \n"
 }
 if ( document.cadastrarusuario.telefone.value == "") {
  erro = erro + "Preencha o Telefone \n"
 }
 if ( document.cadastrarusuario.rg.value == "") {
  erro = erro + "Preencha o RG \n"
 }
 if ( document.cadastrarusuario.cpf.value == "") {
...
<form name="cadastrarusuario" action="cadastrarusuario.do" method="post">
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input name="senha" type="text" id="senha" size="50" maxlength="20" value=""></td>
                      </tr>
                      <tr>
