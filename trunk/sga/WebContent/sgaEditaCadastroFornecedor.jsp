<%-- 
    Document   : sgaEditaCadastroFornecedor
    Created on : 09/12/2007, 21:55:03
    Author     : Hwoarang
--%>
...
function ValidaFormulario(){
 var erro= "";
 if ( document.editarfornecedor.razaosocial.value == "") {
  erro = erro + "Preencha a razão social \n"
 }
 if ( document.editarfornecedor.endereco.value == "") {
  erro = erro + "Preencha o Endereço \n"
 }
 if ( document.editarfornecedor.telefone.value == "") {
  erro = erro + "Preencha o Telefone \n"
 }
 if ( document.editarfornecedor.rgie.value == "") {
  erro = erro + "Preencha o RG/IE \n"
 }
  if ( document.editarfornecedor.cpfcnpj.value == "") {
  erro = erro + "Preencha o CPF/CNPJ \n"
 }
 if(erro == ""){
  document.editarfornecedor.submit();
 }else{
 	alert(erro);
 }
}
...
<form name="editarfornecedor" action="editarfornecedor.do" method="post">
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td  valign="top" bgcolor="a0d7f3" class="CelulaCentro"><table width="95%" border="0" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF">
                      ...
                      <input type="hidden" name="cod" value="${fornecedor.codigo}">
                      <tr>
                        <td width="11%" class="style1">Nome:</td>
                        <td colspan="3" valign="middle"><input name="razaosocial" type="text" id="razaosocial" size="50" maxlength="45" value="${fornecedor.razaosocial}">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input name="endereco" type="text" id="endereco" size="50" maxlength="60" value="${fornecedor.endereco}"></td>
                      </tr>
                      <tr>
                        <td class="style1">Telefone:</td>
                        <td colspan="3"><input name="telefone" type="text" id="telefone" size="25" maxlength="25" value="${fornecedor.telefone}" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>
                      <tr>
                        <td class="style1">RG/IE:</td>
                        <td width="30%"><input name="rgie" type="text" id="rgie" size="20" maxlength="20" value="${fornecedor.rgie}" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                        <td width="18%"><div align="right"><span class="style1">CPF/CNPJ:</span></div></td>
                        <td width="41%"><input name="cpfcnpj" type="text" id="cpfcnpj" size="25" maxlength="14" value="${fornecedor.cpfcnpj}" OnKeyPress="javascript:return OnlyNumbers(event);"></td>
                      </tr>
                      <tr>
                        <td class="style1">Status:</td>
                        <td colspan="3"><label>
                          <select name="status">
                            <option value="1" <c:if test="${fornecedor.status == '1'}"> selected </c:if> >Ativado</option>
                            <option value="0" <c:if test="${fornecedor.status == '0'}"> selected </c:if> >Desativado</option>
                          </select>
                        </label></td>
                      </tr>
                      </c:forEach>
